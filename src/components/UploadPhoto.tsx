...
const UploadPhoto = ({ title, name, onImageUpload, }: formElementProps) => {
  ...
  return (
    <>
      ...
      <div className="cursor-pointer flex justify-center items-center flex-col rounded-2xl border-2 border-dashed border-[#8784a4] bg-[#4b486a33] text-[#ffffff] w-full h-full text-[1.25rem] font-semibold p-[0.5rem] my-[0.5rem] mx-auto focus:outline-2 focus:font-extrabold">
        <img
