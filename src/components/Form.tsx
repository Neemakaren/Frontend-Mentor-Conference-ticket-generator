...
const Form = ({ onSubmit }: FormProps) => {
  ...
  return (
    <form
      ...
      className="z-1 flex flex-col items-start md:w-3/12 w-11/12 pt-4 xl:pt-2"
    >
      <UploadPhoto
        title="Upload Avatar"
        name="avatar"
      ...
      <button className="cursor-pointer w-full py-2 rounded-2xl mt-4 bg-[#f57261]  border border-[#f57261] text-[#0c082b] text-[.9rem] font-bold ">
        Generate My Ticket
      </button>
    </form>
  );
